...
<head>
    ...
    <title>Visi dan Misi - Transnet Sumatera Barat</title>
...
<x-header2></x-header2>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="max-w-4xl mx-auto space-y-12">
            ...
            <!-- Vision Section -->
            <div class="bg-white rounded-lg shadow-sm border-l-4 border-orange-500 p-8">
                <div class="space-y-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-800 mb-4">Komitmen Kami</h2>
                    <p class="text-gray-600 text-lg">Bersama membangun masa depan yang lebih terhubung</p>
                </div>
