<x-layouts.order-layout :title="'Request Bandwidth'">
                    ...
                    @if ($payments->isNotEmpty())
                        <div class="bg-white my-20 rounded-lg p-8 max-w-4xl mx-auto space-y-6">
                            ...
                            <div class="text-center mb-8">
                                ...
                                <h1 class="text-3xl font-bold text-gray-900 mb-4">Request Bandwidth</h1>
                                <p class="text-gray-600 text-sm">
                                    Lakukan request upgrade atau downgrade bandwidth sesuai kebutuhan.
                                </p>
                            </div>
                                ...
                                <div>
                                    ...
                                    <select name="current" required id="current" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                                        @foreach ($payments as $payment)
                                                ...
                                                <input type="number" name="bwFrom" value={{ $payment->order->packet->bandwidth }} hidden>
