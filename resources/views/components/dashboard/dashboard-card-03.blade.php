<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    <div class="px-5 py-10 flex flex-col h-full justify-between gap-3">
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-2xl font-extrabold text-gray-800 dark:text-gray-100">Customer</h2>
            <svg xmlns="http://www.w3.org/2000/svg" class="mr-5 hover:cursor-pointer hover:scale-125 transition-transform ease-out" width="20" height="20" fill="currentColor" class="bi bi-arrow-up-right" viewBox="0 0 16 16" onclick="window.location.href='{{ route('customers') }}'">
