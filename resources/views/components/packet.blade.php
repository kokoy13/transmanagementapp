...
<div class="max-w-7xl mx-auto">
    ...
    <div class='mt-15 flex justify-center items-center'>
        ...
        <div class="px-6 ">
                <a href="/packets" class="w-full py-3 px-4 bg-indigo-600 text-nowrap hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200 flex items-center justify-center">
                    LIHAT SELENGKAPNYA
                    <svg class="ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" />
                    </svg>
