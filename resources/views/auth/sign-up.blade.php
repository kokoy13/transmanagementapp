    ...
    <div class="min-h-screen max-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        <div class="w-full max-w-6xl overflow-hidden bg-white rounded-2xl shadow-xl">
            ...
            <div class="flex flex-col md:flex-row">
                <!-- Left side - Image -->
                <div class="relative h-48 md:h-auto md:w-1/2">
                    <!-- Back button -->
                    <div class="absolute z-20 left-5 top-5">
                        <a href="/" class="group px-4 py-2 flex items-center gap-2 bg-white rounded-full shadow-md transition-all hover:shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-gray-700 transition-colors" viewBox="0 0 16 16">
                                <path d="m3.86 8.753 5.482 4.796c.646.566 1.658.106 1.658-.753V3.204a1 1 0 0 0-1.659-.753l-5.48 4.796a1 1 0 0 0 0 1.506z"/>
                            </svg>
                            <span class="text-gray-700 font-medium transition-colors">Back to Home</span>
                        </a>
                    </div>
