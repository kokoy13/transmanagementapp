    ...
    >
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
                ...
                <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-10">
                    <!-- Add view button -->
                    <a href='{{ route('user.create') }}' class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
        ...
        <x-table-user :users="$users"></x-table-user>
    </div>
</x-app-layout>
