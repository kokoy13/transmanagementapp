    ...
    >
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
                ...
                <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                    ...
                    <!-- Add view button -->
                    <a href='{{ route('order.create') }}' class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
        ...
        <x-table-order :orders="$orders"></x-table-order>
    </div>
</x-app-layout>