  ...
  <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl relative">
    ...
    <form method="post" action="/sign-in" class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <div class="flex items-center justify-between mt-4">
          ...
          <span class="text-xs text-center text-gray-500 uppercase">or login
              with</span>
        ...
        <div class="flex justify-between gap-5">
            {{-- Google --}}
            <a href="{{route('auth.redirect','google' )}}" class="flex w-full  px-8 py-3 gap-2 items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                <div class="">
            ...
            {{-- facebook --}}
            <a href="{{route('auth.redirect', 'facebook')}}" class="flex w-full px-8 py-3 gap-2 items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                <div class="">
                ...
                <span class="w-5/6 font-bold text-center">Facebook</span>
            </a>
        </div>

        <div class="flex justify-center mt-4">

            <a href="sign-up" class="text-sm text-gray-500">Don't have an account? <span class="underline">create one</span></a>
