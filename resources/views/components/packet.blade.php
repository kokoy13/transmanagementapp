...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 relative z-40">
        ...
        <div data-aos='fade-up' class="pricing-card bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-100">
            ...
            <div class="px-6 pb-6">
                <a @if(Auth::check()) href="{{ route('packet.details', $packet->id) }}" @else href="/sign-in" @endif class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200 flex items-center justify-center">
                    PESAN SEKARANG
